...
import themes, { makeMonacoTheme } from "../style/theme";
...
const EditorArea = styled.main`
    ...
    .highlighted-line + div {
        color: ${props => props.theme.editor.lineNumberH1};
        background-color: ${props => props.theme.editor.lineNumberH1Background};
        font-weight: bold;
    }
    ...
    .placeholder-text {
        ...
        &::after {
            content: 'Please paste (or type) some code/stuff...';
        }
    }
`;
